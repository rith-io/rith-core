...
class Seed(Endpoint):
    """Instantiate the Role Endpoints.
    ...
    def role_preprocessor_get_single(instance_id=None, **kw):
        """Create an Role specific GET_SINGLE preprocessor.

        Accepts a single argument, `instance_id`, the primary key of the
        instance of the model to get.
        """
        logger.info('`role_preprocessor_get_single` responded to request')
    ...
    def role_preprocessor_get_many(search_params=None, **kw):
        """Create an Role specific GET_MANY preprocessor.

        Accepts a single argument, `search_params`, which is a dictionary
        containing the search parameters for the request.
        """
        logger.info('`role_preprocessor_get_many` responded to request')
    ...
    def role_preprocessor_update_single(instance_id=None, **kw):
        """Create an Role specific PATCH_SINGLE and PUT_SINGLE preprocessor.
        ...
        """
        logger.info('`role_preprocessor_update_single` used for endpoint')
    ...
    def role_preprocessor_update_many(search_params=None, **kw):
        """Create an Role specific PATCH_MANY and PATCH_SINGLE preprocessor.
        ...
        """
        logger.info('`role_preprocessor_update_many` used for endpoint')
    ...
    def role_preprocessor_delete_single(instance_id=None, **kw):
        """Create an Role specific DELETE_SINGLE preprocessor.

        Accepts a single argument, `instance_id`, which is the primary key
        of the instance which will be deleted.
        """
        logger.info('`role_preprocessor_delete_single` used for endpoint')
    ...
    def role_postprocessor_get_single(result=None, **kw):
        """Create an Role specific GET_SINGLE postprocessor.

        Accepts a single argument, `result`, which is the dictionary
        representation of the requested instance of the model.
        """
        logger.info('`role_postprocessor_get_single` responded to request')

    def role_postprocessor_get_many(result=None, search_params=None, **kw):
        """Create an Role specific GET_MANY postprocessor.
        ...
        `result`).
        """
        logger.info('`role_postprocessor_get_many` responded to request')

    def role_postprocessor_update_single(result=None, **kw):
        """Create an Role specific PATCH_SINGLE and PUT_SINGLE postprocessor.

        Accepts a single argument, `result`, which is the dictionary
        representation of the requested instance of the model.
        """
        logger.info('`role_postprocessor_update_single` used for endpoint')

    def role_postprocessor_update_many(query=None, data=None,
                                       search_params=None, **kw):
        """Create an Role specific PATCH_MANY and PATCH_SINGLE postprocessor.
        ...
        """
        logger.info('`role_postprocessor_update_many` used for endpoint')

    def role_postprocessor_post(result=None, **kw):
        """Create an Role specific POST postprocessor.

        Accepts a single argument, `result`, which is the dictionary
        representation of the created instance of the model.
        """
        logger.info('`role_postprocessor_post` used for endpoint')

    def role_postprocessor_delete_single(was_deleted=None, **kw):
        """Create an Role specific DELETE_SINGLE postprocessor.

        Accepts a single argument, `was_deleted`, which represents whether
        the instance has been deleted.
        """
        logger.info('`role_postprocessor_delete_single` used for endpoint')

    def role_postprocessor_delete_many(result=None, search_params=None,
                                       **kw):
        """Create an Role specific DELETE_MANY postprocessor.
        ...
        request.
        """
        logger.info('`role_postprocessor_delete_many` used for endpoint')
    ...
    __arguments__ = {
        ...
        'preprocessors': {
            'GET_SINGLE': [role_preprocessor_get_single],
            'GET_MANY': [role_preprocessor_get_many],
            'PUT_SINGLE': [role_preprocessor_update_single],
            'PUT_MANY': [role_preprocessor_update_many],
            'PATCH_SINGLE': [role_preprocessor_update_single],
            'PATCH_MANY': [role_preprocessor_update_many],
            'POST': [role_preprocessor_post],
            'DELETE': [role_preprocessor_delete_single]
        },
        'postprocessors': {
            'GET_SINGLE': [role_postprocessor_get_single],
            'GET_MANY': [role_postprocessor_get_many],
            'PUT_SINGLE': [role_postprocessor_update_single],
            'PUT_MANY': [role_postprocessor_update_many],
            'PATCH_SINGLE': [role_postprocessor_update_single],
            'PATCH_MANY': [role_postprocessor_update_many],
            'POST': [role_postprocessor_post],
            'DELETE': [role_postprocessor_delete_single]
        },
